				...
				<div class="border border-5 p-3 rounded-end rounded-start">
					...
					<form>
						<div class="col-6 row g-3" style="margin-left: auto; margin-right: auto;">
							<div class="col">
								<label for="anjuran" class="col-sm-2 col-form-label">Anjuran: </label> {{ $course->Course_Organization }}
							</div>


							<div class="col-12">
								<label for="Tempat" class="col-sm-2 col-form-label">Tempat: </label> {{ $course->Course_Venue }}
							</div>

							<div class="col-12">
								<label for="tarikh" class="col-sm-2 col-form-label">Tarikh Mula: </label> {{ $course->Course_DateStart }}
							</div>

							<div class="col-12">
								<label for="tarikh" class="col-sm-2 col-form-label">Tarikh Tamat: </label> {{ $course->Course_DateEnd }}
							</div>

							<div class="col-12">
								<label for="masa" class="col-sm-2 col-form-label">Masa: </label> {{ $course->Course_Time }}
							</div>
